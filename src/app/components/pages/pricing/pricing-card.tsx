    ...
    <div>
        <div className="divide-y rounded-md border border-primary shadow-sm">
            <div className="p-6 sm:px-8">
              ...
              <Button disabled={true}  className="mt-4 block w-full">Active</Button>
            </div>
            ...
            <div className="p-6 sm:px-8">
              ...
              <ul className="mt-2 space-y-2 sm:mt-4">
                <li className="flex items-center gap-1">
                  <Check></Check>
                  <span className="text-primary ml-1">100 Points of free Credits per Month</span>
                </li>
                <li className="flex items-center gap-1">
                  <Check></Check>
                  <span className="text-primary ml-1">High Resolution Generation</span>
                </li>
                <li className="flex items-center gap-1">
                  <X></X>
